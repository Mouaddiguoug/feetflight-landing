...
function howItWorks() {
  return (
    <div id='how_it_works' className='w-full mt-32 flex justify-center items-center h-screen'>
    
      <div className='w-[85%] gap-5 md:gap-7 bg-[#12171D]/60 backdrop-blur-2xl flex flex-col justify-center items-center rounded-3xl h-full md:h-[70%]'>
      ...
      <img src='assets/color-sharp2 1.png' className='w-2/6 absolute right-0 -z-10' />
        ...
        <img src='assets/roadmap_vertical.png' className='h-[80%] md:hidden block' />
      </div>
    </div>
  )
}
